...
class AdminModel extends BaseModel
{
   ...
   * 存储登陆信息的key
   */
    public static $loginHash = 'uhash';

  /**
   * 存储管理员权限的key
   */
    public static $permitsHash = 'upermit';
   ...
   */
    ...
    {
        Session::set(self::$loginHash, serialize($this->data()));
      ...
      /* 获取权限信息 */
        ...
        Session::set(self::$permitsHash, $this->permits);
    }
   ...
   */
    ...
    {
        if (!$uhash = Session::get(self::$loginHash)) {
            self::$udata = null;
        } else {
            self::$udata = unserialize($uhash);
        }

        self::$upermits = Session::get(self::$permitsHash);
    }
   ...
   */
    ...
    {
        Session::set(self::$loginHash, null);
        Session::set(self::$permitsHash, null);
    }
